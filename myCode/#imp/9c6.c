...
void in_or_out(float p[], float x, float y)
{
    ...
    if ((a == are1[0] + are1[2] + are1[1]) && are1[0] != 0 && are1[1] != 0 && are1[2] != 0)
    {
        printf("The point D(%0.3f,%0.3f) is INSIDE the triangle.\n", x, y);
    }
    else if ((a == are1[0] + are1[2] + are1[1]))
    {
        printf("The point D(%0.3f,%0.3f) is ON the triangle.\n", x, y);
    }
    else
    {
        printf("The point D(%0.3f,%0.3f) is OUTSIDE the triangle.\n", x, y);
    }
}
...
int main()
{
    ...
    if (c == 'Y' || c == 'y')
    {
        ...
        {
            printf("The area of the triangle formed by the line joining between A,B and C is %f\n", are(p));
        }
    }
